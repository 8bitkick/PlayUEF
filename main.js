...
var PlayUEF = function() {
  ...
  function startPlayer(uef){
    ...
    // Use just the file's basename for the tape label (FILE may be a full URL), without extension
    uef.name = decodeURIComponent(uef.name).split(/[?#]/)[0].split("/").pop().replace(/\.(uef|zip)$/i, "");
